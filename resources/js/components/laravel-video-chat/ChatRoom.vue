                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <ul class="chat" v-chat-scroll>
                            <li :key="message.id" class="clearfix" v-for="message in messages" v-bind:class="{ 'right' : check(message.sender.id), 'left' : !check(message.sender.id) }">
                            <span class="chat-img" v-bind:class="{ 'pull-right' : check(message.sender.id) , 'pull-left' : !check(message.sender.id) }">
                                ...
                                <div class="chat-body clearfix">
                                    ...
                                    <div class="row">
                                        <div :key="file.id" class="col-md-3" v-for="file in message.files">
...
<!--
 ...
 -->
        ...
        <div class="row">
            <div :key="file.id" class="col-md-3" v-for="file in conversation.files">
                <img :src="file.file_details.webPath" alt="" class="img-responsive">
                <a :href="file.file_details.webPath" target="_blank" download>Download - {{ file.name }}</a>
            </div>
        </div>
